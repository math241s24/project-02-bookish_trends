...
To give every individual user an ID, I did keep their email and time stamp of the response. This was never shared.
...
I also cannot ignore the possibility for bias by those who self selected to partake in the questionnaire. Those who took this survey might have heightened or exaggerated opinions about books and their presence online.

I did a lot of work for this project to come to the conclusion that there really is not any strong evidence of a connection between Social media and Book sales/rating. I did multiple regession analsyis tests and visualizations. I underestimated the popularity of children's books, whose demographic are not on online book platforms. Children and their parents may learn about new books from word of mouth and not necessarily by engaging online. There can be some overlap between parents and book centered social media, but not much.

I do not believe that this project was in vain. When I was somewhat fruitless in my project, I did consider changing the course of my project to do more predictive modeling based one the type of social media people were active on or how frequent they were online. The time component question I asked about was very much ripe with user error and subjectivty to the extreme that attempting predictive modeling might be as helpful. Just because I did not find a strong correlation does not mean that this project was a waste.

I see the results as somewhat hopeful. Readers are not mindless who will buy whatever is advertised. The hype surrounding books is not enough to cause a book to skyrocket in sales. Substance is also considered. Overall this project showed that the growing "aesthetic of reading" does not trump the craft writing
